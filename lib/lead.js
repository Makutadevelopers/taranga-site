...
export function trackCtaClick(type, placement, label) {
  if (typeof window.gtag === 'undefined') return;
  window.gtag('event', 'cta_click', {
    cta_type: type || 'unknown',
...
export function trackSubmitAttempt(type) {
  if (typeof window.gtag === 'undefined') return;
  window.gtag('event', 'lead_submit_attempt', { cta_type: type || 'unknown' });
}
export function trackSubmitError(type, field) {
  if (typeof window.gtag === 'undefined') return;
  window.gtag('event', 'lead_submit_error', {
    cta_type: type || 'unknown',
    error_field: field || 'unknown',
  });
}
