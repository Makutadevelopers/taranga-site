          ...
          <div>
            ...
            {!qDone ? (
              <div className="qform" id="qform" style={{ flexDirection: 'column', maxWidth: '400px', margin: 0 }}>
                ...
                <a href="#" className="btn solid" style={{ textAlign: 'center' }} onClick={(e) => { e.preventDefault(); quickSubmit(); }}>Request a Visit</a>
              </div>
            ) : (
              <div className="qform" id="qform" style={{ flexDirection: 'column', maxWidth: '400px', margin: 0 }}>
      ...
      <section className="wrap" id="faq" style={{ padding: 'clamp(2rem,5vw,3rem) 0 clamp(5rem,9vw,7rem)' }}>
        <div className="reveal">
          ...
          <div className="faq">
            ...
            <div className="q"><button>How do I book a site visit?</button><div className="a"><p>Fill the form above or tap &ldquo;Book a Visit&rdquo; anywhere on the site, and we&rsquo;ll call you to arrange a convenient time. Visits are private and no-obligation.</p></div></div>
          </div>
        </div>
      </section>
    </>
