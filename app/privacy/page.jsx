...
export const metadata = {
  ...
  description:
    'How Makuta Taranga (Makuta) collects, uses and protects the details you share through enquiry forms, calls and WhatsApp.',
  ...
  return (
    <>
      ...
      <section className="wrap legal" style={{ padding: 'clamp(1rem,4vw,2rem) 0 clamp(4rem,8vw,6rem)', maxWidth: '760px' }}>
        <h2>Who we are</h2>
        <p>
          This website is operated by Makuta (&ldquo;we&rdquo;, &ldquo;us&rdquo;) to market the residential
