// Plain data module (no 'use client') so both the server Journal page (for the
// FAQPage JSON-LD) and the client <Faq> accordion can import the same list.
export const FAQ_ITEMS = [
  {
    q: 'Where exactly is Makuta Taranga?',
    a: 'IDL Road, opposite IDL Lake, Hyderabad — 500072, between Kukatpally and Balanagar. Kukatpally metro is about 800 m away. See the Location page for the map.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes — TS RERA P02200011012, verifiable on the Telangana RERA portal.',
  },
  {
  ...
  },
  {
    ...
    a: 'Fill an enquiry form or tap “Book a site visit” anywhere on the site, and we’ll call you to arrange a convenient time. Visits are private and no-obligation.',
  },
];
